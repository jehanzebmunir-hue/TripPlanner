...
export const en = {
  ...
  discover: {
    ...
    sortConfidence: "Sort: most confident first",
  ...
  checklist: {
    subheading: "Booking items from your itinerary, plus real weather-based packing and a generic prep timeline.",
    fromItinerary: "From your itinerary",
    packingTitle: "Packing",
    packingSourceForecast: "Real forecast",
    packingSourceHistorical: "Historical average for these dates",
    packingRain: "Pack a rain jacket or umbrella",
    packingRainHint: "{{source}}: {{percent}}% chance of rain",
    packingWarmLayer: "Pack a warm layer",
    packingWarmLayerHint: "{{source}}: avg low {{lowC}}°C ({{lowF}}°F)",
    packingSunProtection: "Pack sun protection",
    packingSunProtectionHint: "{{source}}: avg high {{highC}}°C ({{highF}}°F)",
    weeksOut: "Weeks out",
