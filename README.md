...
- **Language support** — still not started. Flagged as needing a real scope decision (UI chrome only vs. translated place data, which sources are even multi-lingual) before any i18n scaffolding goes in, rather than picking one silently.
